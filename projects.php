...
// tkhrbi9a here
$result1 = $mysqli->query("SELECT `pid`, `price` FROM `post_req` WHERE `pid` = $pid");
...
<body id="page-top">
        ...
        <div class="container text-center">
            ...
            <div class="sinup-box card border-primary">
                ...
                <div class="card-body text-left">
                    ...
                    <h4 class="card-title h5">Freelencer price </h4>
                    <p class="card-text" id="price"><i class="fa fa-rupee"></i> <?= $row1['price'] ?></p>
                    <h4 class="card-title h5">Project Description</h4>
                    <p class="card-text" id="detail"><?= ucfirst($row['detail']) ?></p>
                    <h4 class="card-title h5">Project status</h4>
                    <?php
                    ...
                    ?>
                            ...
                            <!--  start heeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeer4564196851468541968 -->
                        <?php
                        }
                    } else {
    ...
    <script>
        function initPayPalButton() {
            var detail = document.querySelector('#smart-button-container #detail');
            var price = document.querySelector('#smart-button-container #price');
            var invoiceid = document.querySelector('#smart-button-container #invoiceid');
            var invoiceidError = document.querySelector('#smart-button-container #invoiceidError');
            var invoiceidDiv = document.querySelector('#smart-button-container #invoiceidDiv');

            var elArr = [detail, price];
            ...
            paypal.Buttons({
                ...
                onClick: function() {
                    ...
                    purchase_units[0].detail = detail.value;
                    purchase_units[0].price.value = price.value;
                ...
                onApprove: function(data, actions) {
                    return actions.order.capture().then(function(orderData) {
                        ...
                        element.innerHTML = '';
                        actions.redirect('download.html');
